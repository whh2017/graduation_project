...
function MaskIt(obj){
			var hoverdiv = '<div class="divMask" style="position: fixed; width: 100%; height: 100%; left: 0; top: 0; background-color: #000; opacity: .8 ;z-index:20; filter:Alpha(Opacity=80);"></div>';
